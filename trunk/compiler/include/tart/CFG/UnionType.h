...
#if 0
// TODO: Canonical representation of a union type.
// Note: Need some way to define a deterministic order for types.
class UnionTypeSet {
public:
private:
};
...
public:
  ...
  static UnionType * create(const SourceLocation & loc, const TypeList & members);
