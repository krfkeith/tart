    ...
    if (VariableDefn * var = dyn_cast<VariableDefn>(target)) {
      switch (var->storageClass()) {
        ...
        case Storage_Local: {
          ...
          // to the module so that the compiler can generate instances of those types.
          // TODO: I don't remember what this code is for.
          /*if (var->parentDefn() == Builtins::typeType->typeDefn()) {
