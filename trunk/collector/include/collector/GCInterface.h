...
/* llvm_cg_walk_gcroots - This function is exposed by the LLVM code
 * generator, and allows us to traverse the roots on the stack.
 */
...
/* llvm_gc_write - This function should be implemented to include any
 * write barrier code that is needed by the garbage collector.
 */
